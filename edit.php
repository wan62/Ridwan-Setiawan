			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<select name="fakultas" class="form-control" required>
						...
						<option value="FAKULTAS KEDOKTERAN" <?php if($data['fakultas'] == 'FAKULTAS KEDOKTERAN'){ echo 'selected'; } ?>>FAKULTAS KEDOKTERAN</option>
						<option value="FAKULTAS PERTANIAN" <?php if($data['fakultas'] == 'FAKULTAS PERTANIAN'){ echo 'selected'; } ?>>FAKULTAS PERTANIAN</option>
						<option value="FAKULTAS HUKUM" <?php if($data['fakultas'] == 'FAKULTAS HUKUM'){ echo 'selected'; } ?>>FAKULTAS HUKUM</option>
					</select>
				</div>
			</div>
			<div class="form-group row">
